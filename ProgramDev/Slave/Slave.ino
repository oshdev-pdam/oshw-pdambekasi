...
#define SSerialRX        9 //10  //Serial Receive pin
#define SSerialTX        12 //11  //Serial Transmit pin

#define SSerialTxControl 10 //3   //RS485 Direction control
#define SSerialTxControlRe 11 //tambahan
