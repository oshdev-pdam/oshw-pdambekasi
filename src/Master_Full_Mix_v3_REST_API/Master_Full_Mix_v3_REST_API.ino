...
const char feedPressureBar[] = "/no3-pressure-bar/data";
const char feedPressurePsi[] = "/no3-pressure-psi/data";
const char feedCurSensor[] = "/no3-cursensor/data";
const char feedBatVoltage[] = "/no3-batvoltage/data";
const char feedTempCels[] = "/no3-tempcels/data";
const char feedQuota[] = "/no3-quota/data";
...
void loop() {
  ...
  if(timeCounter >= waitTime){
    ...
    //sprintf(fileName, "C%04d%02d%02d.txt",now.year(),now.month(),now.day());
